...
class PathsConfig(BaseModel):
    DATASET_PATH: str = "/home/work/skku/hyo/hyo/dataset/word.parquet"
...
CKPT_DIR = Path(config.paths.CKPT_DIR if hasattr(config, 'paths') and hasattr(config.paths, 'CKPT_DIR') else "./checkpoints_v3")
