...
GRID_SEARCH_BASE_DIR = "/home/work/skku/hyo/hyo/grid_search_results_word" # 모든 그리드 서치 결과 저장 기본 폴더
...
rvq_tokenizer = RVQTokenizer(
    ...
    n_emb=RVQ_N_EMB, 
    hidden=256,
    TOKENIZER_CHECKPOINT_PATH="/home/work/skku/hyo/hyo/model/rvq_best_model_word_12_512.pt" # 실제 경로로 수정!
).to(DEVICE)
rvq_tokenizer.eval() # 토크나이저는 학습하지 않으므로 eval 모드

eeg_dataset_full = EEGDataset(data_dir="/home/work/skku/hyo/hyo/dataset/word.parquet") # 실제 경로로 수정!
